...
if __name__ == '__main__':
    ...
    setting_name = args.exp_name + '_FedGKT' + '_node_num'+ str(args.node_num)+'_select'+str(args.select_ratio) + '_dir' + str(args.dirichlet_alpha) + '_E' + str(args.client_epoch) + '_' + args.client_model_type + '_feature' + args.data_feature_partition + '_Randomseed' + str(args.random_seed)
    ...
    for i in range(args.node_num): 
        ...
        if args.client_model_type == 'homo':
    ...
    for rounds in range(args.T):
        ...
        # central server receive knowledge from clients
